...
import {debug_log} from "./modules/logging.js";

// Module's entry point
Hooks.on("ready", async () =>
{
    debug_log("Loading NPC Sheet");
    LootSheetConstants.LootSheetPf1NPC = (await import("./modules/lootsheet-npc.js")).LootSheetPf1NPC;

    debug_log("Loading Complete. Registering");
    ...
    debug_log("Registering Complete");
});
...
Hooks.on('preCreateOwnedItem', (actor, item, data) =>
{
    ...
    if (!actor)
    {
        throw new Error(`Parent Actor ${actor._id} not found`);
    }
